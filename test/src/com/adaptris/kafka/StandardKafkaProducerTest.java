...
public class StandardKafkaProducerTest {
  ...
  public static void setUpClass() throws Exception {
    ...
    wrapper.start();
    // System.out.println("Wrapper Start Complete: " + new Date());
    // wrapper.createTopic(StandardKafkaProducerTest.class.getCanonicalName());
    // System.out.println("Wrapper createTopic Complete: " + new Date());
  }
  ...
  public void testSend() throws Exception {
    try {
      ...
      StandaloneProducer p =
          new StandaloneProducer(createProducer(wrapper.getConnections(), text, StandardKafkaProducerTest.class.getCanonicalName()));
  ...
  private StandardKafkaProducer createProducer(String bootstrapServer, String recordKey, String topic) {
    ...
    StandardKafkaProducer producer = new StandardKafkaProducer(recordKey, new ConfiguredProduceDestination(topic), builder);
    return producer;
  }
